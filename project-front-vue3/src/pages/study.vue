        ...
        <Container>
          <div class="flex justify-between w-full">
            ...
            <div class="flex items-center">
              <!-- 搜索 -->
              <div
                class="relative bg-white rounded-6 pl-4 pr-2 h-full flex items-center mr-4"
              >
                <input
                  type="text"
                  class="outline-none mr-2"
                  placeholder="搜索课程"
                />
...
.types {
  .item {
    @apply px-4 py-1 rounded bg-gray-100 bg-opacity-20 mr-2 cursor-pointer;
    &:hover {
