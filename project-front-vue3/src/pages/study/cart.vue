<template>
  <div class="py-4 relative bg-gray-100 flex-1">
    <Container>
      <ul class="w-full pb-15">
        ...
        >
          ...
          <div
            class="flex-1 flex flex-col items-start border-r-1 h-full py-3 px-4 justify-around"
          >
            <!-- 标题 -->
    ...
    <div class="absolute bottom-0 left-0 w-full">
      <Container
        class="bg-white flex justify-between items-center w-full px-2 py-2 box-border"
        style="padding: 10px"
      >
        <div class="flex">
          <!-- checkbox -->
